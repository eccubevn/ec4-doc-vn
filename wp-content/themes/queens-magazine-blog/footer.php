		...
		<div class="site-info row footer-background ">
			<div class = "col-lg-12 col-md-12 margin-section mt-5 foot-top" >
				<div  class = "col-lg-3 col-md-3 float-left wow fadeInLeftBig"  >
					...
					if ( absint( get_theme_mod('queens_magazine_blog_most_used_categories_enable','1')) == 1) {
						?>
				...
				<div  class = "col-lg-6 col-md-6 float-left" >
					...
					if ( absint( get_theme_mod('queens_magazine_blog_most_commented_post_enable','1')) == 1) {
					?>
						<div class="widget widget_categories">
				...
				<div  class = "col-lg-3 col-md-3 float-left wow fadeInRightBig" >
					...
					if ( absint( get_theme_mod('queens_magazine_blog_copyright_enable','1')) == 1) {
					?>
					<div class="widget widget_categories">
