	...
	function queens_magazine_blog_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-links pr-1 d-block theme-hover">' . esc_html__( 'Tagged %1$s', 'queens-magazine-blog' ) . '</span>', $tags_list ); // WPCS: XSS OK.
			}
		}
		...
		edit_post_link(
			...
			'<span class="edit-link pl-1 theme-hover">',
			'</span>'
		);
	}
endif;
