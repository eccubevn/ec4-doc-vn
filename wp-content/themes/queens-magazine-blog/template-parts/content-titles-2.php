...
?>
	...
	<?php
				...
				<?php endif; ?>
					<h2 class="post-title-2 mt-4 mb-3 theme-hover text-center"><a href = "<?php the_permalink(); ?>" title = "<?php the_title_attribute(); ?>" ><?php the_title(); ?></a></h2>
				...
				if ( absint( get_theme_mod( 'queens_magazine_blog_most_recent_post_taxonomy_'.__('Comment & Tag','queens-magazine-blog'),'1' )) == 1) :
					?> <div class = " post-auther-edit-2 tag-border-line "> <?php queens_magazine_blog_entry_footer(); ?> </div> <?php
				endif; ?>
